class ScenariosController < ApplicationController
  before_action :set_scenario, only: %i[show edit update destroy create_task_file]
  ...
  def create_task_file
    ...
    file_path = Scenarios::CreateTaskFile.call(scenario: @scenario, explanations: explanations).file_path
